    ...
    >
      ...
      <div className="grid grid-cols-1  lg:grid-cols-3 gap-7 gap-y-10">
        ...
        {uniqueFeed.map((video) => {
          // Check if user purchased this video (convert IDs to string to avoid mismatch)
          const hasPurchased = user?.purchasedVideos?.some(
            (id) => id.toString() === video._id.toString()
          );
          //       console.log("Video ID:", video._id);
          // console.log("Purchased IDs:", user.purchasedVideos);
          // console.log("Match found:", user.purchasedVideos.some(id => id.toString() === video._id.toString()));
