      ...
      <div className="relative z-10 w-[88%] max-w-3xl bg-white bg-opacity-90 backdrop-blur-md rounded-xl shadow-xl flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="md:w-1/2 p-6 md:p-10 flex flex-col justify-center">
          <form onSubmit={handleRegister} className="space-y-4 md:space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-[#9d3a75] via-[#7b1c8f] to-[#4d004d] hover:from-[#7b1c8f] hover:via-[#6a0070] hover:to-[#3d003d] text-white font-bold py-2 rounded-lg shadow-lg"
            >
              Register
            </button>
          </form>
